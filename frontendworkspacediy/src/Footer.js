            ...
            <div className="main-ftr">
                ...
                <div className="div-ftr2">
                    ...
                    <div className="ftr2-rft">
                        <p><Link to="/privacypolicy" style={{ color: 'inherit', textDecoration: 'none' }}>Privacy Policy</Link> <Link to="/termsandconditions" style={{ color: 'inherit', textDecoration: 'none' }}>Terms & Conditions</Link> <Link to="/temporary" style={{ color: 'inherit', textDecoration: 'none' }}>Ad Choices</Link></p>
                    </div>
