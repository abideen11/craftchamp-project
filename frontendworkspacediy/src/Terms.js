    ...
    render() {
        return(
            <div className="main-tac">
                <div className="div-tac"></div>
                <div className="div-tac2">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CraftChamp.</p>
                        </li>
                        <li>
                            <p><b>Country</b> refers to: Texas,  United States</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><b>Website</b> refers to CraftChamp, accessible from www.genericwebsite.com</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: contact@genericwebsite.com</li>
                    </ul>
                </div>
                <div className="div-tac3"></div>
            </div>
        )
    }
}